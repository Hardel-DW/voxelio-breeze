...
import { DEFAULT_MOD_METADATA, ModPlatforms } from "./index.ts";
 ...
 */
export function generateForgeMods(
	commonData: ModMetadata,
	platforms: ModPlatforms[],
) {
	const modLoader = platforms.includes(ModPlatforms.FORGE)
		? "lowcodefml"
		: "javafml";
